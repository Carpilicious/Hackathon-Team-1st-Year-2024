...
public class AddressConverter {
    ...
    private double longitude;
     ...
     /*
       CONSTRUCTOR for AddressConverter
       @Param - the address of the location to obtain its latitude and longitude. Address must be a string and in the format 'Address, Town/City, Postcode (optional)'
     */

    AddressConverter(String address) throws IOException, InterruptedException {
    ...
    private double extractCoordinates(String returnInfo, String cmd){
        ...
        if (locMatcher.find()) {
            ...
            System.out.println("Latitude: " + loc);
            return loc;
        }
        return 0;
